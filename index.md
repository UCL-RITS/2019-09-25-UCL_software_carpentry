...
address: "Lab 1, Physics Building, University College London, WC1E 6BT"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "51.525435,-0.133241"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Mian Asbat Ahmad", "Anastasis Georgoulas", "David Pérez-Suárez", "Ben Waugh"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Samantha Ahern", "Vilma Agalioti-Sgompou", "John Deacon", "Mosè Giordano", "Sarah Keating", "Tuomas Koskela", "Frank Otto", "Alastair Smith", "Tim Spain"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-09-25-UCL   # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 73215301939          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="collaborative_notes">
  ...
  Saved copy of the <a href="201909_SoftwareCarpentry.html">collaborative notes taken during the workshop</a>.
</p>
{% endif %}
